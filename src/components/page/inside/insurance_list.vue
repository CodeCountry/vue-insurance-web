            ...
            <el-col :span="24">
                ...
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                    ...
                    <el-form-item label="支付状态">
                        <el-select v-model="formInline.isSignMsg" placeholder="支付状态">
                            <el-option label="全部" value=" "></el-option>
                            <el-option v-for="item in statusPayArr" :key="item" :label="item" :value="item"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="被保状态">
                        <el-select v-model="formInline.irPlyStatusDesc" placeholder="被保状态">
                            <el-option label="全部" value=" "></el-option>
                            <el-option v-for="item in statusArr" :key="item" :label="item" :value="item"></el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-table  v-loading="loading" :data="tableData" border style="width: 100%">
                    ...
                    <el-table-column prop="isInsureDate" label="投保日期"></el-table-column>
                    <el-table-column prop="isApplNo" label="分期订单号" width="110px"></el-table-column>
                    <el-table-column prop="pdProcNm" label="分期项目"></el-table-column>
                    <el-table-column prop="isTimes" label="分期期数"></el-table-column>
                    <el-table-column prop="irInsNo" label="保障订单号"  width="130px"></el-table-column>
                    <el-table-column prop="insureCode" label="保障名称"></el-table-column>
                    <el-table-column prop="isInsuredName" label="被保人姓名"></el-table-column>
                    <el-table-column prop="isInsuredIdNo" label="身份证号码" width="140px"></el-table-column>
                    <el-table-column prop="isInsuredPhone" label="手机号码" width="100px"></el-table-column>
                    <el-table-column prop="isPayMoney" label="售价"></el-table-column>
                    <el-table-column prop="isSignMsg" label="支付状态"></el-table-column>
                    <el-table-column prop="irPlyStatusDesc" label="投保状态"></el-table-column>
                    <el-table-column prop="irInsPlyNos[0]" label="投保单号1"></el-table-column>
                    <el-table-column prop="irInsPlyNos[1]" label="投保单号2"></el-table-column>
                    <el-table-column prop="irCreateDate" label="导入时间"></el-table-column>
...
<script type="text/ecmascript-6">
    export default {
        ...
        created () {
            ...
            self.$api.get('/insurance/protitle', null, r =>{
                console.log(r.data);
                if (r.code === 200) {
            ...
            self.$api.get('/insurance/signmsg', null, r =>{
                console.log(r.data);
                if (r.code === 200) {
                    self.statusPayArr = r.data;
                }else{
                  alert(r.message);
                }
                self.loading = false;
            });
            self.$api.get('/insurance/plystatus', null, r =>{
                console.log(r.data);
                if (r.code === 200) {
        ...
        methods: {
            ...
            onSubmit () {
                ...
                let formInline1 = {
                    ...
                    isSignMsg: formInline.isSignMsg,
